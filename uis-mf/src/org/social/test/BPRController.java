...
public class BPRController {
 ...
 // read an input-stream into a String
  ...
  public static void main(String[] arg) throws Exception {
    ...
    String ifmfModel = "java -Xmx80960m -jar BPR-Fast.jar 2 2 " + arg[0] +" " + arg[1] +" " +arg[2];
    String evaluate = "java -Xmx80960m -jar BPR-Fast.jar 2 1 " + arg[0] +" " + arg[1] +" " +arg[2];
    
    BPRController r = new BPRController();
    r.runShell(ifmfModel);
    
    BPRController e = new BPRController();
    e.runShell(evaluate);
